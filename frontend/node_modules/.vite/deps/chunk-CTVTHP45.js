...
(function(Lab2) {
  ...
  function toColor(lab) {
    ...
    x = Xn * lab_xyz(x);
    z = Zn * lab_xyz(z);
    var r = xyz_rgb(3.2404542 * x - 1.5371385 * y - 0.4985314 * z);
  ...
  function rgbToXyz(r, g, b) {
    ...
    var y = xyz_lab((0.2126729 * r + 0.7151522 * g + 0.072175 * b) / Yn);
    var z = xyz_lab((0.0193339 * r + 0.119192 * g + 0.9503041 * b) / Zn);
    return [x, y, z];
  }
})(Lab || (Lab = {}));
...
(function(Color2) {
  ...
  function toRgbString(hexColor) {
    return "RGB: ".concat(Color2.toRgb(hexColor).join(", "));
  }
...
var ColorListOptions = ColorListNames.map(function(n) {
  return [n, ColorLists[n].label, capitalize(ColorLists[n].type)];
});
var ColorListOptionsScale = ColorListOptions.filter(function(v) {
  return ColorLists[v[0]].type === "diverging" || ColorLists[v[0]].type === "sequential";
});
var ColorListOptionsSet = ColorListOptions.filter(function(v) {
  return ColorLists[v[0]].type === "qualitative";
});
...
//# sourceMappingURL=chunk-CTVTHP45.js.map
