...
var PluginFeatureDetection = {
  get preferWebGl1() {
    ...
    if (unpportedSafariVersions.some(function(v) {
    ...
    var isTouchScreen = navigator.maxTouchPoints >= 4;
...
var PluginConfigItem = (
  /** @class */
  function() {
    function PluginConfigItem2(key, defaultValue) {
      this.key = key;
      this.defaultValue = defaultValue;
    }
    PluginConfigItem2.prototype.toString = function() {
      return this.key;
    };
    PluginConfigItem2.prototype.valueOf = function() {
      return this.key;
    };
    return PluginConfigItem2;
  }()
);
...
var PluginConfigManager = (
  /** @class */
  function() {
    function PluginConfigManager2(initial) {
      var _this = this;
    ...
    PluginConfigManager2.prototype.get = function(key) {
      if (!this._config.has(key))
        return key.defaultValue;
      return this._config.get(key);
    };
    PluginConfigManager2.prototype.set = function(key, value) {
      this._config.set(key, value);
    };
    PluginConfigManager2.prototype.delete = function(key) {
      this._config.delete(key);
    };
    return PluginConfigManager2;
  }()
);
...
//# sourceMappingURL=chunk-3ILHUM2S.js.map
